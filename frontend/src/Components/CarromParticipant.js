...
const CarromParticipant = () => {
 ...
 getGames()
  ...
  const getGames=async()=>{
    let  result=await fetch("http://localhost:8080/individualevents/event3",{
      method:'post',
  ...
  const collectData = async () => {
   ...
   const  result=await fetch("http://localhost:8080/carromparticipant",{
      method:'post',
...
export default CarromParticipant;
